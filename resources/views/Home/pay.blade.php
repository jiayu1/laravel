...
<html>
	<head>
		...
		<link href="{{ asset('weilai/AmazeUI-2.4.2/assets/css/amazeui.css') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('weilai/basic/css/demo.css') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('weilai/css/cartstyle.css') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('weilai/css/jsstyle.css') }}" rel="stylesheet" type="text/css" />

		<script type="text/javascript" src="{{ asset('weilai/js/address.js') }}"></script>
	</head>
	<body>
		<!--顶部导航条-->
			...
			<div class="concent">
				...
				<div class="paycont">
					<div class="address">
						...
						<ul id="addresslist">
							<div class="per-border"></div>
								...
								<span style="display:none" id="session">{{ session('homeuser')->id }}</span>
							<div class="per-border"></div>
					...
					<div class="logistics">
						<h3>选择支付方式</h3>
						<ul class="pay-list">
							<li class="pay card"><img src="{{ asset('weilai/images/wangyin.jpg') }}" />银联<span></span></li>
							<li class="pay qq"><img src="{{ asset('weilai/images/weizhifu.jpg') }}" />微信<span></span></li>
							<li class="pay taobao"><img src="{{ asset('weilai/images/zhifubao.jpg') }}" />支付宝<span></span></li>
						</ul>
					</div>
					<div class="clear"></div>
										...
										<ul class="item-content clearfix">
											<div class="pay-phone">
												<li class="td td-item">
													<div class="item-pic">
														<a href="#" class="">
															<img src="/Admin/upload/{{ $v->pic }} " width='78' height='78' class=""></a>
															 <!-- itempic J_ItemImg -->
													</div>
													<div class="item-info">
												...
												<li class="td td-price">
													<div class="item-price price-promo-promo">
														<div class="price-content">
															<em class="J_Price price-now" id="ddd">{{ $v->price }}</em>
														</div>
													</div>
												</li>
											</div>
    ...
    <!-- for="user-phone -->
			...
			<li class="user-addresslist" id=""  style="display:none" info="showaddress">
				...
				<div class="new-addr-btn">
					...
					<a href="javascript:doDel({{ session('homeuser')->id }})" onclick="delClick(this);">删除</a>
					  <!-- <a href="javascript:doDel({{ session('homeuser')->id }})">删除</a> -->
				</div>
