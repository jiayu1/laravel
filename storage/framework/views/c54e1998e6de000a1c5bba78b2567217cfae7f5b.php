                ...
                <ul class="list-unstyled side-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/admins">显示管理信息</a></li>
                            <li><a href="/admin/admins/create">添加管理员</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="<?php echo e(url('admin/type')); ?>">分类信息</a></li>
                            <li><a href="<?php echo e(url('admin/type/create')); ?>">分类添加</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="<?php echo e(url('admin/goods')); ?>">商品信息</a></li>
                            <li><a href="<?php echo e(url('admin/goods/create')); ?>">商品添加</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="<?php echo e(url('admin/order')); ?>">显示订单信息</a></li>
                            <li><a href="<?php echo e(url('admin/order/create')); ?>">订单添加</a></li>
                        </ul>
                    </li>
                </ul>
